...
-- ========== KẾT THÚC PHẦN 1 ==========
-- Phần 2 sẽ bắt đầu từ đây (UI Components)
-- UI Components
...
local sidebarSubtitle = makeTextLabel(sidebar, "AI_Beta-VietNamese_1.0.3", 12, "semibold")
